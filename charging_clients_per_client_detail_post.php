<?php
	...
	if (isset($_POST['back'])) {
		header("Location: charging_clients_per_client_post.php?date_from=$date_from&date_to=$date_to&client_code=$client_code");
		exit();
	}
?>
		<h1><a href='<?php echo "charging_clients_per_client_post.php?date_from=$date_from&date_to=$date_to&client_code=$client_code"; ?>' style="text-decoration:none;" title="Back">&#8656;</a> Client Charging per Client Post</h1>
