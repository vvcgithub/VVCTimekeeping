<?php 
	...
	if (isset($_POST['insert'])) {
		...
		if ((loa_period_code_exists_insert($period_code, $employee_id_no) === true) && !empty($period_code))  {
...
?>
	<h1><a href='<?php echo "reviews_check_report.php?employee_id_no=$employee_id_no&period_code=$period_code"; ?>' style="text-decoration:none;" title="Back">&#8656;</a> Insert Leave</h1>
