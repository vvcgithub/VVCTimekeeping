...
<?php
		...
		for($page=$beginno;$page<=$endno;$page++) {
			echo ($page == $current_page) ? "<li class='bold'><a href='?page=$page&sort=$sort&order=$order&text_search=$text_search'>$page</a></li>" : "<li><a href='?page=$page&sort=$sort&order=$order&text_search=$text_search'>$page</a></li>";
		}
