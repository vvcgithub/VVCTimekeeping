...
?>
		<h1><a href="logs_list.php" style="text-decoration:none;">&#8656;</a> Preview Logs</h1>
...
<?php
					...
					include 'core/database/connect.php' ;
					$query = $mysqli->query("SELECT SUM(log_late) as log_late_sum, SUM(log_undertime) as log_undertime_sum, SUM(log_a) as log_a_sum, SUM(log_b) as log_b_sum, SUM(log_c) as log_c_sum, SUM(log_d) as log_d_sum, SUM(log_e) as log_e_sum, SUM(log_f) as log_f_sum, SUM(log_g) as log_g_sum, SUM(log_h) as log_h_sum, SUM(log_i) as log_i_sum, SUM(log_regular) as log_regular_sum FROM logs WHERE log_employee_id_no='$employee_id_no' AND log_period_code = '$period_code' ORDER BY log_date ASC");
...
?>				
					...
					<tr style='background:white;'>
						<td colspan='18'>&nbsp;A - Overtime rendered during regular working days (125%)
							...
							<br>&nbsp;I - Work rendered during the first 8 hours on a special non working and regular holiday (160%)
						</td>
					</tr>
<?php
...
?>
					<tr><td colspan='18'><br /></td></tr>
					<tr style="background:white;">
						<td colspan="15" class="right bold">TOTAL WORKING DAYS</td><td class="bold center"><?php echo $total_working_days; ?></td><td colspan="2"></td>
					</tr>
					<tr style="background:white;">
					...
					<tr style="background:white;">
						<td colspan="15" class="right bold">TOTAL</td><td class="center bold"><?php echo $total; ?></td><td colspan="2"></td>
					</tr>
				</tbody>
			</table>
			<br />
