...
<?php	
				...
				while($rows = $query->fetch_assoc()) {
					...
					if($row_log) { // get data from db
						...
						$overtime = $log_a_sum + $log_b_sum + $log_c_sum + $log_d_sum + $log_e_sum + $log_f_sum + $log_g_sum + $log_h_sum;
					} else {
						$log_late_sum = "";
						$log_undertime_sum = "";
						$log_a_sum = "";
...
?>
				...
				<tr class="alternate">
					...
					<td><a href='<?php echo "reviews_logs_check.php?employee_id_no=$employee_id_no&period_code=$period_code" ; ?>'><?php echo $csv_emp_name[] = complete_name_from_id_no($employee_id_no); ?></a></td>
...
?>
				...
				<tr class="bg-color-dimgrey fg-color-white">
					<th colspan="20" class="left">
						...
						<input type="submit"  value="Generate" name ="generate"class="button_text"><?php echo "This button is tempory unavailable"; ?>
						<input type="hidden" value="<?php echo $csv_hdr; ?>" name="csv_hdr">					
						<input type="hidden" value="<?php echo $csv_periodcode; ?>" name="csv_periodcode">
						
							<?php
							$ctr = 0;
							foreach($csv_emp_id as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_emp_id[$ctr];?>" name = "csv_emp_id[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_emp_name as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_emp_name[$ctr];?>" name = "csv_emp_name[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_TWD as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_TWD[$ctr];?>" name = "csv_TWD[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_SL as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_SL[$ctr];?>" name = "csv_SL[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_VL as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_VL[$ctr];?>" name = "csv_VL[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_LWOP as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_LWOP[$ctr];?>" name = "csv_LWOP[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_others as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_others[$ctr];?>" name = "csv_others[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_TOTAL as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_TOTAL[$ctr];?>" name = "csv_TOTAL[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_late as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_late[$ctr];?>" name = "csv_late[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_undertime as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_undertime[$ctr];?>" name = "csv_undertime[<?php echo $ctr; ?>]">
							...
							<?php
							$ctr = 0;
							foreach($csv_overtime as $value){ 
								if($ctr != 0){
							?>
								<input type="hidden" value="<?php echo $csv_overtime[$ctr];?>" name = "csv_overtime[<?php echo $ctr; ?>]">
								<?php 
								} $ctr++; }
							?>
