<?php
	...
	header("Location: costing_clients_per_client_detail_post.php?date_from=$date_from&date_to=$date_to&client_code=$client_code");
	}
	
?>
		<h1><a href='<?php echo "costing_clients_post.php?date_from=$date_from&date_to=$date_to"; ?>' style="text-decoration:none;" title="Back">&#8656;</a> Client Costing per Client Post</h1>
