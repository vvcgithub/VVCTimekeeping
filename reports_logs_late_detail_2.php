	...
	<table class="table_list print">				
		<thead>
			...
			<tr class="bg-color-dimgrey fg-color-white">						
				...
				<th class="center" style="min-width:60px;">Rate</th>
				<th class="center" style="min-width:50px;">Late</th>
				<th class="center" style="min-width:90px;">Late Cost</th>
...
?>
			...
			<tr class="alternate">
				...
				<td class="center"><?php echo number_format($position_rate, 2, '.', ','); ?></td>
				<td class="center"><?php echo (!empty($log_late)) ?  number_format($log_late, 2, '.', ',') : "-"; ?></td>
				<td class="center"><?php echo (!empty($log_late)) ?  $late_cost : "-"; ?></td>
...
?>
			<tr class="bg-color-lightblue">
				...
				<td class="center bold"><?php echo (!empty($log_late_sum)) ?  number_format($gtotal_late_cost, 2, '.', ',') : "-"; ?></td>
				<td class="right bold"></td>
