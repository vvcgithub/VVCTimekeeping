...
?>
	<h1><a href="charging_main.php#charging_clients_parameter" style="text-decoration:none;" title="Back">&#8656;</a> Client Charging Post</h1>
...
?>
			<tr class="alternate">
				...
				<td><a href="charging_clients_per_client_post.php?date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to; ?>&client_code=<?php echo $client_code; ?>"><?php echo $client_name; ?></a></td>
