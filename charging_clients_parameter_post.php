<?php
	...
	if (employee_account_type($employee_data['employee_id']) <> 'Administrator' && privilege_charging($employee_data['employee_id']) != 6) {
...
?>	
	<h1><a href="charging_main.php" style="text-decoration:none;" title="Back">&#8656;</a> Client Charging</h1>
